...
export default function BankConfigModal({ isOpen, onClose, children }: BankConfigModalProps) {
  ...
  const onSubmit = (data: BankConfigFormData) => {
    ...
    localStorage.setItem('initialBanca', data.initialBalance.toString());
    localStorage.setItem('monthlyGoal', data.monthlyGoal.toString());
    localStorage.setItem('defaultLotSize', data.defaultLotSize.toString());
