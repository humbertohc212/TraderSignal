          ...
          <div className="flex items-center space-x-4">
            {user ? (
              <>
                ...
                {/* User Profile */}
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-3 bg-white/5 rounded-2xl px-4 py-2 backdrop-blur-sm border border-white/10">
                    ...
                    <div className="hidden md:block">
                      ...
                      <div className="text-xs text-purple-300">
                        {user.role === "admin" ? "Administrador" : "Trader Pro"}
                      </div>
                    </div>
                  </div>
